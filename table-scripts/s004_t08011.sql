DROP TABLE S004.S004_T08011 CASCADE CONSTRAINTS;

CREATE TABLE S004.S004_T08011
(
  TRAN_NO        NUMBER,
  TRAN_DATE      DATE,
  ID_NO          NUMBER,
...
COMMENT ON TABLE S004.S004_T08011 IS 'Vaccination Reservation Transaction Table';


CREATE OR REPLACE TRIGGER S004."S004_T08011_BI001" 
before insert or update or delete
 ON S004.S004_T08011 for each row
begin
   if inserting then
      if :new.tran_no is null then
         select s004_t08011_sq001.nextval
         into :new.tran_no 
         from dual;
      end if; 
